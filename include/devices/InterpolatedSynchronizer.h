...
/**
 * @file InterpolatedSynchronizer.h
 * @ingroup devices
 * The InterpolatedSynchronizer class.
 */
 ...
 */
class AUD_API InterpolatedSynchronizer : public ISynchronizer
{
private:
	// The last time that the reported buffer position changed
	std::chrono::time_point<std::chrono::steady_clock> t1;
	double prev_pos = 0;
	double offset = 0;
	double adjust = 0;
	bool is_playing = false;
	bool reset_time_interpolator = false;
