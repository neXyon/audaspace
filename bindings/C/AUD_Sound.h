...
extern AUD_API AUD_Sound* AUD_Sound_mutable(AUD_Sound* sound);
     ...
     * \return A handle of the time-stretched, pitch scaled sound.
     */
    extern AUD_API AUD_Sound* AUD_Sound_animateableTimeStretchPitchScale(AUD_Sound* sound, double timeRatio, double pitchScale, AUD_StretcherQualityOption quality,
