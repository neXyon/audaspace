 ...
 */
extern int AUD_init(AUD_DeviceType device, DeviceSpecs specs, int buffersize);
 ...
 */
extern void AUD_setSyncCallback(syncFunction function, void *data);
#endif
...
extern const char *AUD_mixdown(AUD_Sound *sound, unsigned int start, unsigned int length,
                               ...
                               DeviceSpecs specs, Container format,
                               Codec codec, unsigned int bitrate);
 ...
 */
extern AUD_Device *AUD_openMixdownDevice(DeviceSpecs specs, AUD_Sound *sequencer, float volume, float start);
